 ...
 * ```
 */
export function assign<T extends object, U extends object>(object: T, ...sources: U[]): T & U {
  if (!sources.length) {
 ...
 * ```
 */
export function assignIn<T extends object, U extends object>(object: T, ...sources: U[]): T & U {
  if (!sources.length) {
    return object as T & U;
  }
